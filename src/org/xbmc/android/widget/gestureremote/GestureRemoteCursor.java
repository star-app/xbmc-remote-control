...
class GestureRemoteCursor {
	...
	public GestureRemoteCursor(Context context, int drawable, int drawable_press) {
		this(context, drawable,drawable_press, new Point(0, 0));
	}

	public GestureRemoteCursor(Context context, int drawable, int drawable_press, Point point) {
		BitmapFactory.Options opts = new BitmapFactory.Options();
		opts.inJustDecodeBounds = true;
		img = BitmapFactory.decodeResource(context.getResources(), drawable);
		img_press = BitmapFactory.decodeResource(context.getResources(), drawable_press);
		coordX = point.x;
		coordY = point.y;
