...
public class MovieDetailsActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mMovieDetailsController.setupLocalPlayButton((Button)findViewById(R.id.moviedetails_localplaybutton));
	...
	private static class MovieDetailsController extends AbstractController implements INotifiableController, IController {
		...
		public void setupLocalPlayButton(Button button){
			button.setOnClickListener(new OnClickListener(){
				public void onClick(View v) {
					Intent it = new Intent(Intent.ACTION_VIEW);  
	                Uri uri = Uri.parse(mMovie.getPath());  
